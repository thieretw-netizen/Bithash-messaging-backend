...
transporter.verify((error, success) => {
  if (error) {
    ...
    console.log('Email server is ready. Sender: info@bithashcapital.live');
  }
});

// ======================
// PROFESSIONAL EMAIL TEMPLATE - EXACT MATCH TO REFERENCE
// Logo centered, proper positioning of all components
// ======================
...
<body>
  <div class="email-container">
    ...
    <!-- BODY SECTION - White Background (Admin's content goes here) -->
...
async function sendEmailCampaign(campaign) {
  console.log(`Starting email campaign: ${campaign._id}, Recipients: ${campaign.recipients.length}, Sender: info@bithashcapital.live`);
  try {
    ...
    for (const recipient of campaign.recipients) {
      try {
        ...
        // Create professional email with proper branding (logo centered, white body)
...
app.listen(PORT, async () => {
  ...
  console.log('Sender email: info@bithashcapital.live');
